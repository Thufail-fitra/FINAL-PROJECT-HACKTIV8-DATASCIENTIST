...
st.title("💬 -SQL Fitra Ajax Assistant- dibuat dengan sepenuh hati dengan LangGraph")
st.caption("tanya o apapun tentang data penjualan saja, jangan sak karep e dewe yaa gesd !!!")
